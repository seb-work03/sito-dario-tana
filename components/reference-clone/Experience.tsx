  ...
  return (
    <section className="bg-white px-5 py-16 md:py-24">
      <div className="mx-auto max-w-[1536px]">
        <span className="font-mono text-sm tracking-widest text-[#0D0D0D]/60">[ EXPERIENCE ]</span>
        <h2 className="text-[#0D0D0D] font-medium text-[32px] md:text-[48px] leading-tight max-w-2xl mt-4 mb-16 md:mb-24">
          ...
          {engagements.map((e, i) => (
            ...
            >
              <motion.div
                ...
                className="relative rounded-3xl overflow-hidden aspect-[4/3] bg-black/5"
              >
                <Image
              ...
              >
                <span className="font-mono text-sm text-[#5372B0]">{`0${i + 1}`.slice(-2)}</span>
                <h3 className="text-[#0D0D0D] text-2xl md:text-4xl font-medium mt-3 mb-4">{e.title}</h3>
                <p className="text-[#0D0D0D]/70 text-base md:text-lg max-w-md">{e.description}</p>
              </motion.div>
            </div>
          ))}
        </div>

        <div className="mt-20 md:mt-28 border-t border-black/10 pt-14">
          <span className="font-mono text-sm tracking-widest text-[#0D0D0D]/60">[ R ]</span>
          <h3 className="text-[#0D0D0D] font-medium text-[28px] md:text-[40px] mt-4">Multi-Sector Work</h3>
          <p className="text-[#0D0D0D]/70 mt-3 max-w-lg">
